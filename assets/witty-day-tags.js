...
export const WITTY_DAY_TAGS = {
  witty: {
    ...
    rain: {
      ...
      56: { time: ['day'], months: [10, 11, 12, 1, 2, 3], region: ['western-cape', 'karoo', 'free-state', 'gauteng'] },
      57: { time: ['day'] },
      58: { time: ['day'], region: 'western-cape', months: [5, 6, 7, 8, 9] },
      59: { time: ['day'], region: 'western-cape', months: [5, 6, 7, 8, 9] },
      60: { time: ['day'] },
    ...
    clear: {
      ...
      39: { time: ['morning'], region: 'western-cape' },
      40: { time: ['morning'] },
      41: { time: ['morning'], region: 'highveld' },
      42: { time: ['morning'] },
      43: { time: ['morning'] },
      44: { time: ['morning'], region: 'western-cape' },
      45: { time: ['morning'] },
      46: { time: ['morning'] },
      47: { time: ['morning'] },
      48: { time: ['morning'], region: 'western-cape' },
      49: { time: ['morning'] },
      50: { time: ['morning'] },
      51: { time: ['morning'] },
      52: { time: ['morning'] },
      ...
      61: { time: ['day'], region: 'highveld' },
      62: { time: ['day'] },
      63: { day: 'weekend', time: ['day'] },
      64: { time: ['day'] },
      65: { time: ['day'], region: 'karoo' },
      66: { time: ['day'] },
      67: { time: ['day'], region: 'western-cape' },
      68: { time: ['day'] },
      69: { time: ['day'], region: 'western-cape' },
      70: { time: ['day'], region: 'western-cape' },
      71: { time: ['evening'], region: 'western-cape' },
      72: { time: ['evening'] },
      73: { time: ['evening'] },
      74: { time: ['evening'] },
      75: { day: 'weekend', time: ['evening'] },
      76: { time: ['evening'] },
      77: { time: ['evening'], region: 'highveld' },
      78: { time: ['evening'], region: 'western-cape' },
      79: { time: ['evening'] },
      80: { time: ['evening'] },
      81: { time: ['evening'] },
      82: { time: ['evening'], region: 'western-cape' },
      83: { time: ['evening'] },
      84: { time: ['evening'] },
      85: { time: ['evening'] },
      86: { time: ['evening'], region: 'western-cape' },
      87: { time: ['evening'] },
      88: { time: ['night'] },
      89: { time: ['night'] },
      90: { time: ['night'] },
