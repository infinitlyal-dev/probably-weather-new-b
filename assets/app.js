document.addEventListener("DOMContentLoaded", () => {
  ...
  const T = {
    ...
    witty: {
      storm: {
        en: ["Jislaaik, stay inside!", "Thunder's grumbling, hey.", "The dog's under the bed. Smart move, honestly.", "Even the hadedas are quiet.", "The sky's having a full-on tantrum.", "Nature's doing its own load shedding.", "Cancel everything. Even your excuses.", "Weather so dramatic it needs a Carte Blanche segment.", "This is why Noah built a boat.", "The braai is cancelled. Yes, really.", "Somewhere a roof is someone's new kite.", "Even the bakkies on the N2 pulled over."],
        af: ["Jinne, bly binne!", "Die donder dreun.", "Die hond is onder die bed. Slim skuif, eerlikwaar.", "Selfs die hadedas is stil.", "Die lug het 'n volle woedebuie.", "Natuur doen sy eie beurtkrag.", "Kanselleer alles. Selfs jou verskonings.", "Weer so dramaties dit het 'n Carte Blanche insetsel nodig.", "Dis hoekom Noag 'n ark gebou het.", "Die braai is gekanselleer. Ja, regtig.", "Iewers is 'n dak iemand se nuwe vlieër.", "Selfs die bakkies op die N2 het stilgehou."],
        zu: ["Yoh, hlala ngaphakathi!", "Izulu liyaduma.", "Inja ingaphansi kombhede. Isu elihle, eqinisweni.", "Ngisho ama-hadeda athule.", "Isibhakabhaka sithukuthele ngempela.", "Imvelo yenza ukucisha kwayo.", "Khansela konke. Ngisho nezaba zakho.", "Isimo sezulu esinomdlalo esidinga i-Carte Blanche.", "Yingakho uNowa wakha umkhumbi.", "Ukosa kukhanselelwe. Yebo, ngempela.", "Endaweni ethile uphahla lungumkhumbi omusha.", "Ngisho namabakkie ku-N2 amile eceleni."],
        xh: ["Yhuu, hlala ngaphakathi!", "Iindudumo ziyagquma.", "Inja ingaphantsi kombhede. Icebo elihle, ngenene.", "Iintaka zithe cwaka.", "Isibhakabhaka siqumba ngokupheleleyo.", "Indalo yenza ukucima kwayo.", "Rhoxisa yonke into. Nezizathu zakho.", "Imozulu edramatiki kakhulu ifuna i-Carte Blanche.", "Yiyo le nto uNowa wakha umkhombe.", "Ukugrila kurhoxisiwe. Ewe, nyhani.", "Kwezinye iindawo uphahla lungumntla omtsha.", "Neebakkie kwi-N2 zime ecaleni."],
        st: ["Eish, dula ka hare!", "Ledimo le a duma.", "Ntja e ka tlas'a bethe. Mohato o bohlale, ka nnete.", "Esita le dinonyana di kgutsitse.", "Lehodimo le halefile ka botlalo.", "Tlhaho e etsa load shedding ea eona.", "Hlakola tsohle. Esita le mabaka a hao.", "Leholimo le dramatic le hloka Carte Blanche.", "Ke kahoo Noa a ileng a haha sekepe.", "Braai e hlakotsoe. E, ka nnete.", "Mohlomong sebakeng se seng marulelo ke khaete e ncha.", "Esita le li-bakkie tsa N2 li emile ka thoko."]
      },
      rain: {
      ...
      cloudy: {
        ...
        st: ["Lehodimo ha le fane letho.", "Ho na le maru empa re tla phela.", "Letsatsi le letle la ho tsamaea, le lebe la ho tjhesa.", "Letsatsi le balehile kajeno.", "Leholimo le matšoenyehong. Le nna, ka nnete.", "Ha ho mpe, ha ho motle. Joalo ka dethi ea 6/10.", "Leholimo le lokileng la Woolies le Netflix.", "Lehodimo le a buffera.", "Esita le leholimo ha le khathalehe kajeno.", "Grey vibes. Lehodimo le tšoana le Mantaha oa ka."]
      },
      uv: {
