  ...
  const T = {
    ...
    witty: {
      storm: {
        ...
        zu: ["Yoh, hlala ngaphakathi!", "Izulu liyaduma.", "U-Eskom ufisa ukuba namandla anje.", "Ngisho ama-hadeda athule.", "Isibhakabhaka siyadinwa ngempela.", "Imvelo yenza ukucisha kwayo.", "Khansela konke. Ngisho nezaba zakho.", "Isimo sezulu esinomdlalo esidinga i-Carte Blanche.", "Yingakho uNowa wakha umkhumbi.", "Ukosa kukhanselelwe. Yebo, ngempela.", "Ndawana uphahla lungumkhumbi omusha.", "Umbani ubeka i-Eskom ehlazweni."],
        xh: ["Yhuu, hlala ngaphakathi!", "Iindudumo ziyagquma.", "U-Eskom unqwenela la mandla.", "Neentak zithe cwaka.", "Isibhakabhaka siqumba ngokupheleleyo.", "Indalo yenza ukucima kwayo.", "Rhoxisa yonke into. Nezizathu zakho.", "Imozulu edramatiki kakhulu ifuna i-Carte Blanche.", "Yiyo le nto uNowa wakha umkhombe.", "Ukugrila kurhoxisiwe. Ewe, nyhani.", "Ndaweni ithile uphahla lungumntla omtsha.", "Umbane ubeka i-Eskom ehlazweni."],
        st: ["Eish, dula ka hare!", "Ledimo le a duma.", "Eskom e ka rata matla ana.", "Esita le dinonyana di kgutsitse.", "Lehodimo le halefile ka botlalo.", "Tlhaho e etsa load shedding ea eona.", "Hlakola tsohle. Esita le mabaka a hao.", "Leholimo le dramatic le hloka Carte Blanche.", "Ke kahoo Noa a ileng a haha sekepe.", "Braai e hlakotsoe. E, ka nnete.", "Ho hong moo marulelo ke khaete e ncha.", "Lehadima le bontša Eskom."]
      },
      rain: {
        en: ["The clouds are having a moment.", "Grab your brolly, boet.", "The garden's saying dankie at last.", "The potholes are becoming swimming pools.", "Your car wash was a waste of money.", "Joburg drivers are panicking already.", "Perfect excuse to cancel plans.", "The dams are doing a happy dance.", "The N1 is now a waterpark.", "Good soup weather, not gonna lie.", "Someone's braai just got ruined.", "Rain so heavy it's got its own ID number."],
        af: ["Die wolke het 'n oomblik.", "Vat jou sambreel, boet.", "Die tuin sê uiteindelik dankie.", "Die slaggate word swembaddens.", "Jou karwas was geldmors.", "Joburg-bestuurders paniek al klaar.", "Perfekte verskoning om planne te kanselleer.", "Die damme doen 'n bly dansie.", "Die N1 is nou 'n waterpark.", "Goeie sopweer, nie gaan lieg nie.", "Iemand se braai is sopnat.", "Reën so swaar dit het sy eie ID nommer."],
        zu: ["Amafu anesikhathi sawo.", "Thatha isambulela sakho, boet.", "Ingadi ithi ekugcineni ngiyabonga.", "Imigodi iba amapulazi okubhukuda.", "Ukuwasha imoto kwakho bekuyize yemali.", "Abashayeli baseJoburg sebeyesaba.", "Isizathu esihle sokukhansela izinhlelo.", "Amadamu enza umdanso ojabulayo.", "I-N1 manje yi-waterpark.", "Isimo sezulu esihle sesobho.", "Ukosa komuntu kusanda konakala.", "Imvula enzima kakhulu inombolo ye-ID."],
      ...
      'rain-possible': {
        ...
        st: ["Mohlomong pula, mohlomong che. Setso.", "Maru a shebahala a belaela ka nnete.", "Nka sampolela ho ba sireletsehile, hey.", "50/50 ho ba metsi. Joalo ka papadi.", "Se ke oa tšepa maru ao. A rera.", "Leholimo ha le tsebe ho iketsa joalo ka uena Spur.", "Paka sampolela. Kapa o se ke oa paka. Ha re tsebe le rona.", "Lehodimo ha le tsebe. Kena klubeng."]
      },
      cloudy: {
        ...
        af: ["Die lug gee absoluut niks.", "Bewolk maar ons sal oorleef.", "Goeie dag vir 'n stap, slegte dag vir 'n bruining.", "Die son bunk vandag.", "Humeurige weer. Same, eerlikwaar.", "Nie sleg nie, nie great nie. Soos 'n 6/10 date.", "Eskom-vriendelike weer. Geen solar vandag nie.", "Die lug buffer.", "Selfs die weer kan nie gepla word vandag nie.", "Grys vibes. Die lug match my Maandag."],
        ...
        xh: ["Isibhakabhaka asiniki nto.", "Linamafu kodwa siya kuphila.", "Imini entle yokuhamba, embi yokutshisa.", "Ilanga liyabaleka namhlanje.", "Imozulu enosizi. Njengam.", "Ayimbi, ayintle. Njengedethi ye-6/10.", "Imozulu elungele i-Eskom. Akukho solar.", "Isibhakabhaka siyabafura.", "Nayo imozulu ayinakuzikhathaza namhlanje.", "I-grey vibes. Isibhakabhaka sifana noMvulo wam."],
      ...
      wind: {
        ...
        af: ["Hou jou hoed vas! En jou kinders.", "Die suidooster het aangekom. Ongenooid, soos altyd.", "Tafelberg se tafeldoek is uit.", "Die Kaapse Dokter maak huisbesoeke.", "Jou haarstyl? Weg. Aanvaar dit.", "Vlieërplankers het die tyd van hul lewe.", "Die bome doen onvrywillige yoga.", "Iemand se trampoline is nou twee strate weg.", "Perfekte toestande om jou waardigheid te verloor.", "Selfs die meeuwe loop vandag."],
        zu: ["Bamba isigqoko sakho! Nabantwana bakho.", "Umoya waseningizimu ufikile. Ungamenyiwe, njengenjwayelo.", "Indwangu yeTafel Mountain iphumile.", "UDokotela waseKapa wenza ukuvakashela.", "Isitayela sakho sezinwele? Sihambile. Yamukela.", "Abadlali be-kite bajabulile kakhulu.", "Izihlahla zenza i-yoga engafuneki.", "I-trampoline yomuntu manje imigwaqo emibili.", "Izimo eziphelele zokulahlekelwa isithunzi.", "Ngisho nezinkonjane ziyahamba namuhla."],
      ...
      heat: {
        en: ["Jislaaik, it's properly hot!", "You could fry an egg on the N1.", "Ice cream isn't a treat. It's survival.", "Stay hydrated or become a biltong.", "The pool is not optional.", "Hotter than a taxi rank at noon.", "The AC is begging for mercy.", "Your car seat is a weapon right now.", "Too hot to argue. Too hot to function.", "Even your phone's overheating.", "The tar is soft. The people are softer.", "Somewhere a chocolate bar just died."],
        af: ["Jinne, dis ordentlik warm!", "Jy kan 'n eier braai op die N1.", "Roomys is nie 'n treat nie. Dis oorlewing.", "Bly gehidreer of word biltong.", "Die swembad is nie opsioneel nie.", "Warmer as 'n taxi-staanplek teen middag.", "Die AC smeek om genade.", "Jou karsitplek is 'n wapen nou.", "Te warm om te stry. Te warm om te funksioneer.", "Selfs jou foon oorverhit.", "Die teer is sag. Die mense is sagter.", "Iewers het 'n sjokolade net gesterf."],
        zu: ["Yoh, kushisa ngempela!", "Ungabhaka iqanda ku-N1.", "I-ice cream ayisiyona isipho. Yikuphila.", "Hlala unamanzi noma ube yi-biltong.", "Ipulazi alikho ukukhetha.", "Kushisa ukudlula i-taxi rank emini.", "I-AC icela umusa.", "Isihlalo semoto sakho siyisikhali manje.", "Kushisa kakhulu ukuphikisa. Kushisa kakhulu ukusebenza.", "Ngisho nefoni yakho iyashisa.", "I-tar ithambile. Abantu bathambile kakhulu.", "Ndawana ishokoledi isanda kufa."],
        xh: ["Yhuu, kushushu ngempela!", "Ungabhaka iqanda kwi-N1.", "I-ice cream ayisosipho. Kukuphila.", "Hlala unamanzi okanye ube yi-biltong.", "Ipuli ayinakukhethwa.", "Kushushu ngaphezu kwe-taxi rank emini.", "I-AC icela inceba.", "Isihlalo semoto sakho sisixhobo ngoku.", "Kushushu kakhulu ukuxoxa. Kushushu kakhulu ukusebenza.", "Nefowuni yakho iyashushu.", "I-tar ithambile. Abantu bathambile.", "Ndaweni ishokolethi isanda kufa."],
        st: ["Eish, ho tjhesa ka nnete!", "O ka chesa lehe ho N1.", "Ice cream ha se mpho. Ke bophelo.", "Dula o na le metsi kapa o fetohe biltong.", "Pool ha se kgetho.", "Ho tjhesa ho feta taxi rank motsheare.", "AC e kopa mohau.", "Setulo sa koloi ea hao ke sebetsa joale.", "Ho tjhesa haholo ho phehisa. Ho tjhesa haholo ho sebetsa.", "Esita le mohala oa hao o chesang.", "Tara e bonolo. Batho ba bonolo le ho feta.", "Ho hong moo sjokolade e sena ho shoa."]
      },
      fog: {
