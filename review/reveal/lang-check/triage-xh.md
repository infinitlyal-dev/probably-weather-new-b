# lang-check triage — isiXhosa — 2026-09-25

Set: labels-xh.json.
Checked 2 lines in 4.5 s. **0 need a human** (0 high, 0 lower); 2 passed every corpus check.

Doubt types among the triaged lines: .
...
- `d-joke-toggle/show` Bonisa isiqhulo
- `d-joke-toggle/hide` Fihla isiqhulo
