...
describe('buildPickerPaths', () => {
  it('P1 versions every rotating WebP URL while leaving the JPG guard stable', () => {
    ...
    expect(paths.slice(0, -1).every((url) => url.endsWith('?v=20260710-p1'))).toBe(true);
  ...
  it('builds a deduped chain — clear/day/week_1/r=3 drops a redundant step', () => {
    ...
    expect(c).toEqual([
      'assets/images/bg/clear/week_1/day/3.webp?v=20260710-p1',
      'assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1',
  ...
  it('uses cloudy as sibling fallback for cold (full 4-step chain — no collapse)', () => {
    ...
    expect(c).toEqual([
      'assets/images/bg/cold/week_2/night/5.webp?v=20260710-p1',
      'assets/images/bg/cold/week_1/night/1.webp?v=20260710-p1',
      'assets/images/bg/cloudy/week_1/night/1.webp?v=20260710-p1',
      'assets/images/bg/default.jpg',
    ]);
  });
  ...
  it('dedupes when r=1 collapses primary into week_1 fallback', () => {
    ...
    expect(c).toEqual([
      'assets/images/bg/cold/week_1/day/1.webp?v=20260710-p1',
      'assets/images/bg/cloudy/week_1/day/1.webp?v=20260710-p1',
      'assets/images/bg/default.jpg',
    ]);
  });
  ...
  it('handles cold-clear without URL encoding the hyphen', () => {
    ...
    expect(c[0]).toBe('assets/images/bg/cold-clear/week_4/dawn/7.webp?v=20260710-p1');
  ...
  it('produces valid paths for all 9 conditions × 4 weeks × 4 times', () => {
    ...
    const pattern = /^assets\/images\/bg\/[a-z-]+\/week_[1-4]\/(dawn|day|dusk|night)\/[1-7]\.webp\?v=20260710-p1$/;
    let combos = 0;
  ...
  it('clamps invalid week values to 1', () => {
    expect(buildPickerPaths('clear', 'clear', 'day', 0, 3)[0]).toBe('assets/images/bg/clear/week_1/day/3.webp?v=20260710-p1');
    expect(buildPickerPaths('clear', 'clear', 'day', 5, 3)[0]).toBe('assets/images/bg/clear/week_1/day/3.webp?v=20260710-p1');
    expect(buildPickerPaths('clear', 'clear', 'day', -1, 3)[0]).toBe('assets/images/bg/clear/week_1/day/3.webp?v=20260710-p1');
    expect(buildPickerPaths('clear', 'clear', 'day', NaN, 3)[0]).toBe('assets/images/bg/clear/week_1/day/3.webp?v=20260710-p1');
  });

  it('clamps invalid r values to 1', () => {
    expect(buildPickerPaths('clear', 'clear', 'day', 1, 0)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
    expect(buildPickerPaths('clear', 'clear', 'day', 1, 8)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
    expect(buildPickerPaths('clear', 'clear', 'day', 1, 99)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
    expect(buildPickerPaths('clear', 'clear', 'day', 1, -1)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
  });

  it('clamps invalid timeOfDay to day', () => {
    expect(buildPickerPaths('clear', 'clear', 'twilight', 1, 1)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
    expect(buildPickerPaths('clear', 'clear', '', 1, 1)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
    expect(buildPickerPaths('clear', 'clear', null, 1, 1)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
  });

  it('defaults empty folder to clear', () => {
    expect(buildPickerPaths('', 'clear', 'day', 1, 1)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
    expect(buildPickerPaths(null, null, 'day', 1, 1)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
    expect(buildPickerPaths(undefined, undefined, 'day', 1, 1)[0]).toBe('assets/images/bg/clear/week_1/day/1.webp?v=20260710-p1');
  });

  it('honours a custom base path (last entry is always the default guard)', () => {
    const c = buildPickerPaths('clear', 'clear', 'day', 2, 3, '/cdn/v2');
    expect(c[0]).toBe('/cdn/v2/clear/week_2/day/3.webp?v=20260710-p1');
